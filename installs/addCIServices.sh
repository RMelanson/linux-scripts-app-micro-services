...
echo addCIServices.sh EXECUTING: ln -s  /sbin/$app $daemonDir/$daemon
ln -s  /sbin/$app /$daemonDir/$daemon

echo addCIServices.sh EXECUTING: chmod 755 /sbin/$app $daemonDir/$daemon
chmod 755 /sbin/$app $daemonDir/$daemon
